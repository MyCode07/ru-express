...
export const html = () => {
    const antalyaHotels = JSON.parse(fs.readFileSync('src/files/antalya.json', 'utf8'));
    const stambulHotels = JSON.parse(fs.readFileSync('src/files/stambul.json', 'utf8'));
    ...
    return app.gulp.src(app.path.src.html)
        ...
        .pipe(fileInclude({
            ...
            basepath: '@file',
            context: {
                antalyaHotels: antalyaHotels,
                stambulHotels: stambulHotels
            }
        }))
        /*
        .pipe(pug({
